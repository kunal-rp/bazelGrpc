...
/**
 * 
 * Util to handle configuration and fetching of setup information for microservices. 
 * Servers: Call to get port number for server instantiation
 * Client: Call to get target address for said server
 */
